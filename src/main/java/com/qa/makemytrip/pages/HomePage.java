...
public class HomePage {
    ...
    private By privacyPolicy=By.xpath("//div[@class='makeFlex column hrtlCenter loginFooter']//a[text()='Privacy Policy']");
	...
	public String getCountryInitials(String country)
	{
		...
		try
		{
		countryInitials=eUtil.convertTextToXpath("//div[@data-cy='List_57']/span[text()=\""+country+"\"]/following-sibling::span");
		return eUtil.getElementText(countryInitials);
		}
		catch(NoSuchElementException e)
		{
			countryInitials=eUtil.convertTextToXpath("//div[@data-cy='List_57']/span[contains(text(),'"+country+"')]/following-sibling::span");
			return eUtil.getElementText(countryInitials);		
		}
	}
